...
export let scholars: Person[] = [
{
    ...
    publications: [
      ...
      {
        id: "pub-sukesh-j3",
        title: "CamPedV2: A Diverse Real-Time Pedestrian Detection Dataset",
        venue: "The Visual Computer (Under Review)",
        year: 2026,
        month: 3,
        type: "Journal",
        domain: "Visual Surveillance",
        abstract: "Pedestrian detection models often suffer from poor generalization and high false-positive rates when tested on real-time complex scenes, particularly due to visually similar pedestrian-like distractors (e.g., statues or cutouts) and adverse weather conditions. We present CamPedV2, an enriched, large-scale dataset featuring over 100,000 images and 500,000 pedestrian annotations. The dataset curates diverse campus scenes with varying crowd densities, incorporates pedestrian-like distractors from the PnPLO dataset, and applies augmentations for adverse weather conditions (fog, rain, night). Benchmark results show that models trained on CamPedV2 achieve superior mAP and robustness compared to standard datasets like KITTI, Caltech, and CrowdHuman.",
      },
      {
        id: "pub-sukesh-j4",
        title:
          "DECA-YOLO: Dual-Pooling Efficient Channel Attention for Robust Pedestrian Detection",
        venue: "SN Computer Science (Under Review)",
        year: 2026,
        month: 4,
        type: "Journal",
        domain: "Visual Surveillance",
        abstract: "Traditional channel attention mechanisms often overlook spatial-temporal context or add excessive computational overhead. This paper proposes DECA-YOLO, which incorporates a Dual-Pooling Efficient Channel Attention (DECA) module into the YOLO architecture to improve robust pedestrian detection under occlusions and scale variations. By utilizing dual global pooling (both average and max pooling) and efficient channel-wise convolutions, the model adaptively refines feature maps without parameter explosion. Evaluation on public datasets demonstrates that DECA-YOLO achieves a competitive trade-off between detection accuracy and inference latency on edge devices.",
      },
      {
        id: "pub-sukesh-c1",
        title:
      ...
      {
        id: "pub-sukesh-c6",
        title: "Self-Supervised Pretraining for Robust Pedestrian Detection",
        venue: "ICIP (Under Review)",
        year: 2026,
        month: 10,
        type: "Conference",
        domain: "Visual Surveillance",
        abstract: "Supervised training of deep pedestrian detectors requires massive amount of labeled bounding boxes, which is costly and labor-intensive to produce. This paper investigates self-supervised pretraining strategies tailored for pedestrian detection. We employ contrastive learning on large unlabeled campus video streams to learn robust pedestrian representation before fine-tuning with limited labels. Our results demonstrate that self-supervised pretraining enhances detection robustness and reduces the required volume of labeled training data by up to 50%.",
      },
      {
        id: "pub-sukesh-c7",
        title: "BDH Vision: Context-Aware Feature Reasoning",
        venue: "TENCON (Under Review)",
        year: 2026,
        month: 11,
        type: "Conference",
        domain: "Visual Surveillance",
        abstract: "Visual reasoning in complex surveillance scenes requires context awareness beyond pixel-level object classification. We present BDH Vision, a context-aware feature reasoning network that incorporates semantic relationships between objects and their surroundings. The model uses graph-based representation to reason about spatial context and object interactions. Evaluated on pedestrian detection and action recognition tasks, BDH Vision shows improved accuracy in resolving ambiguous classes in cluttered backgrounds.",
      },
      {
        id: "pub-sukesh-c8",
        title: "High-Fidelity Synthetic Iris Generation using Diffusion Models",
        venue: "TENCON (Under Review)",
        year: 2026,
        month: 11,
        type: "Conference",
        domain: "Biometrics",
        abstract: "Collecting large-scale real-world iris datasets raises severe privacy concerns and legal issues. To address this, we propose a class-conditioned diffusion model framework for high-fidelity synthetic iris generation. By leveraging denoising diffusion probabilistic models (DDPM), we synthesize realistic iris textures with high inter-class diversity. Quantitative evaluations using biometric matchers confirm that the synthetic identities are distinct and can be safely used for training recognition systems without exposing real biometric templates.",
      },
      {
        id: "pub-sukesh-c9",
        title: "Multi-Scale Dilated Attention for Robust Pedestrian Detection in YOLO-based Models",
        venue: "TENCON (Under Review)",
        year: 2026,
        month: 11,
        type: "Conference",
        domain: "Visual Surveillance",
        abstract: "In YOLO detectors, uniform attention mechanisms often fail to capture multi-scale context, leading to missed detections of small scale pedestrians. We propose a Multi-Scale Dilated Attention (MSDA) module that applies varying dilation rates to attention maps to capture both local detail and global context. Integrating MSDA into the YOLO neck improves the detection of heavily occluded and small-scale pedestrians. Experiments show a consistent boost in mAP on public surveillance benchmarks.",
      },
      {
        id: "pub-sukesh-c10",
...
export let achievements: Achievement[] = [
  ...
  },
  {
    ...
    detail:
      "Lab head recognised as a senior member of IAPR for contributions to pattern recognition.",
    year: 2023,
    category: "Recognition",
    org: "IAPR",
  },
